...
class Interaktiv_Visualisering:
    """
    Klasse med statiske metoder for å lese, analysere og modellere datasett
    """
...
FILENAME = "rotte.json"  # <-- Put your file here
df_raw = Interaktiv_Visualisering.DataDict(FILENAME)  # Reads and cleans data
...
# To run the program:
# bokeh serve src/interaktiv_app.py --show --port 5006
